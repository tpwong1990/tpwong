...
-- (8th)combine the passport result from 6th and 7th sql result, find the people who take the first flight on 29, July and withdraw money from Leggett Street's ATM and exit the bakery car park
...
-- (9th)find the person who recieve a call on the crime day and the duration less not 60s.
...
-- (10th)find the person who make a call on the crime day and the duration less not 60s.
...
-- (11th) combine the result from 10th sql and 8th sql